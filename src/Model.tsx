...
// Extend JSX namespace with model-viewer component and custom props
declare global {
  namespace JSX {
    interface IntrinsicElements {
      "model-viewer": ModelViewer; // Use the custom props interface
    }
  }
}
  ...
  return (
    ...
    >
      <model-viewer
        ...
        ios-src="/warba_info_13-4-24.usdz"
        alt="3D Model"
